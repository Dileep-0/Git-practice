...
if all(column in df.columns for column in required_columns):
    ...
    for i in range(1, len(df)):
        ...
        prev_buy, prev_sell = previous_row['tot_buy_qty_1'], previous_row['tot_sell_qty_1']
        prev_buy_ce, prev_sell_ce = previous_row['tot_buy_qty_2'], previous_row['tot_sell_qty_2']
        prev_buy_pe, prev_sell_pe = previous_row['tot_buy_qty_3'], previous_row['tot_sell_qty_3']
        ...
        curr_buy, curr_sell = current_row['tot_buy_qty_1'], current_row['tot_sell_qty_1']
        curr_buy_ce, curr_sell_ce = current_row['tot_buy_qty_2'], current_row['tot_sell_qty_2']
        curr_buy_pe, curr_sell_pe = current_row['tot_buy_qty_3'], current_row['tot_sell_qty_3']


        tot_buy_sig, tot_sell_sig = current_row['tot_buy_sig_1'], current_row['tot_sell_sig_1']
        buy_sig, sell_sig = current_row['tot_buy_sig_2'], current_row['tot_sell_sig_2']
        buy_sig2, sell_sig2 = current_row['tot_buy_sig_3'], current_row['tot_sell_sig_3']

        #bank_avg_trade = current_row['avg_trade_price.3']

        prev_ltp_price = previous_row['ltp_1']

        ltp_price, bid_pr, ask_pr = current_row['ltp_1'], current_row['bid_price_1'], current_row['ask_price_1']
        ltp_price_ce, bid_pr_ce, ask_pr_ce = current_row['ltp_2'], current_row['bid_price_2'], current_row['ask_price_2']
        ltp_price_pe, bid_pr_pe, ask_pr_pe = current_row['ltp_3'], current_row['bid_price_3'], current_row['ask_price_3']
