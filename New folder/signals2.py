...
if all(column in df.columns for column in required_columns):
    ...
    for i in range(1, len(df)):
        ...
        if count_Y > 3 and (buy_sum > prev_buy_sum) and (sell_sum < prev_sell_sum) and (buy_sum > 0 and sell_sum < 0) \
        ...
        elif count_Y == 3 and count_N >= 1 and  (buy_sum > prev_buy_sum) and (sell_sum < prev_sell_sum) and (buy_sum > 0 and sell_sum < 0) \
            and ((buy_sum * prev_buy_sum < 0) or (len(str(prev_buy_sum)) < len(str(buy_sum))) or 
            (sell_sum * prev_sell_sum < 0) or (len(str(abs(prev_sell_sum))) < len(str(abs(sell_sum))))) :
        ...
        if not buy_flag:
            if count_YES > 3  and (buy_sum < prev_buy_sum) and (sell_sum > prev_sell_sum) and (buy_sum < 0 and sell_sum > 0) \
            ...
            elif count_YES == 3 and count_N >= 1  and  (buy_sum < prev_buy_sum) and (sell_sum > prev_sell_sum) and (buy_sum < 0 and sell_sum > 0) \
                and ((buy_sum * prev_buy_sum < 0) or (len(str(abs(prev_buy_sum))) < len(str(abs(buy_sum)))) or 
                    (sell_sum * prev_sell_sum < 0) or (len(str(prev_sell_sum)) < len(str(sell_sum)))) :
